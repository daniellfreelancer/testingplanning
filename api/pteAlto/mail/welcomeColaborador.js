    ...
    try {
        ...
        const mailOptions = {
            ...
            <head>
              ...
              <title>Bienvenido/a a Deportes Puente Alto</title>
              ...
              <style>
                ...
                .password-section { background-color: #f8f9fa; border-left: 4px solid #00d09c; padding: 20px; margin: 25px 0; border-radius: 5px; }
                .password-box { background-color: #ffffff; border: 2px solid #00d09c; border-radius: 5px; padding: 15px; margin: 10px 0; text-align: center; }
                .password-value { font-size: 24px; font-weight: 700; color: #00d09c; letter-spacing: 2px; margin: 0; font-family: 'Courier New', monospace; }
                .security-notice { background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0; border-radius: 5px; }
                ...
                @media only screen and (max-width: 620px) {
                  ...
                  .password-value { font-size: 20px !important; letter-spacing: 1px !important; }
                }
              </style>
              <!--[if mso]>
              <style type="text/css">
            ...
            <body style="margin: 0; padding: 0; background-color: #f4f7f6; font-family: 'Montserrat', sans-serif;">
              <center class="email-wrapper">
                ...
                <table class="content-table" align="center" role="presentation" cellspacing="0" cellpadding="0" border="0">
                  ...
                  <tr>
                    <td class="body-content">
                      <p class="welcome-title">¡Bienvenido/a a Deportes Puente Alto!</p>
                      <p class="greeting-text">Hola <span style="font-weight: 600;">${name}</span>,</p>
                      <p class="greeting-text">Nos alegra tenerte como parte del equipo de colaboradores de Deportes Puente Alto.</p>
                      <p class="greeting-text">Tu cuenta ha sido creada exitosamente y ya puedes acceder a la plataforma.</p>
                      
                      <!-- Password Section -->
                      <div style="background-color: #f8f9fa; border-left: 4px solid #00d09c; padding: 20px; margin: 25px 0; border-radius: 5px;">
                        <p style="font-size: 16px; font-weight: 600; color: #1a1a1a; margin: 0 0 10px 0;">Credenciales de Acceso</p>
                        <p style="font-size: 15px; line-height: 1.6; margin: 10px 0; color: #555555;">
                          <strong style="color: #1a1a1a;">Email:</strong> ${email}
                        </p>
                        <p style="font-size: 15px; line-height: 1.6; margin: 10px 0; color: #555555;">
                          <strong style="color: #1a1a1a;">Contraseña temporal:</strong>
                        </p>
                        <div style="background-color: #ffffff; border: 2px solid #00d09c; border-radius: 5px; padding: 15px; margin: 10px 0; text-align: center;">
                          <p style="font-size: 24px; font-weight: 700; color: #00d09c; letter-spacing: 2px; margin: 0; font-family: 'Courier New', monospace;">${password}</p>
                        </div>
                        <p style="font-size: 13px; color: #ff6b6b; margin: 10px 0 0 0; font-weight: 600;">
                          ⚠️ Esta es una contraseña temporal. Por seguridad, deberás cambiarla al ingresar por primera vez.
                        </p>
                      </div>
                      ...
                      <div style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0; border-radius: 5px;">
                        <p style="font-size: 14px; line-height: 1.6; margin: 0; color: #856404;">
                          <strong>🔒 Importante:</strong> Por tu seguridad, te recomendamos encarecidamente cambiar esta contraseña temporal inmediatamente después de iniciar sesión por primera vez. Puedes hacerlo desde tu perfil en la plataforma.
                        </p>
                      </div>
                      ...
                      <div class="button-wrapper">
                        ...
                        <![endif]-->
                        <!--[if !mso]><!-->
                        <a href="https://deportespuentealto.cl/login" class="button" target="_blank">
                          INICIAR SESIÓN
                        </a>
                        <!--<![endif]-->
                      </div>
                ...
                <table class="footer" align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px;">
                  <tr>
                    <td>
                      <p style="margin: 0; padding: 20px;">Visítanos en <a href="https://deportespuentealto.vitalmoveglobal.com" class="footer-link" target="_blank">www.deportespuentealto.cl</a></p>
                      <p style="margin: 0;">Powered by © 2026 VitalMove.</p>
                    </td>
                  </tr>
                </table>
...
module.exports = sendWelcomeColaboradorPuenteAlto;