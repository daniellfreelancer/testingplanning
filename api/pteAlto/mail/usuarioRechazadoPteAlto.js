/**
 * Email de notificación cuando un usuario es rechazado en Puente Alto.
    ...
    const mailOptions = {
      ...
      html: `
        ...
        <head>
          ...
          <title>Registro rechazado - Deportes Puente Alto</title>
          ...
          <style>
            ...
            .btn-actualizar { display: inline-block; margin: 20px 0; padding: 14px 28px; background: #00d09c; color: #fff !important; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px; }
        ...
        <body>
          <div class="container">
            ...
            <div class="body-content">
              <p class="welcome-title">Tu solicitud de registro ha sido rechazada</p>
              <p class="greeting">Hola <strong>${nombre} ${apellido}</strong>,</p>
              <p class="greeting">Te informamos que tu solicitud de registro en la plataforma de la Corporación de Deportes Puente Alto no ha sido aprobada en esta ocasión.</p>
              <div class="datos-box">
                <p class="datos-title">Motivo del rechazo</p>
                <p style="font-size: 14px; line-height: 1.6; color: #555; margin: 0;">${motivoTexto}</p>
              </div>
              <p class="greeting">Puedes actualizar tus datos siguiendo el enlace a continuación para que nuestro equipo revise tu solicitud nuevamente.</p>
              <p style="text-align: center;">
                <a href="${linkActualizarDatos}" class="btn-actualizar" target="_blank">Actualizar datos</a>
              </p>
...
module.exports = sendUsuarioRechazadoPteAlto;
