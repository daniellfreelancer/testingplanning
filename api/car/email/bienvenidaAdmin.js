...
const sendWelcomeProfesionalMail = async (email, password, name, rol) => {
  try {
            ...
            <table class="content-table" align="center" role="presentation" cellspacing="0" cellpadding="0" border="0">
              ...
              <tr>
                <td class="body-content">
                  <p class="welcome-title">¡Bienvenido/a! Acceso Administrador</p>
                  ...
                  <p class="greeting-text">
                    Tu cuenta de administrador fue creada exitosamente. Aquí están tus credenciales de acceso:
                  </p>
    ...
    console.log("Email de bienvenida (administrador) enviado con éxito: Receive ok");
  } catch (error) {
    console.log(error);
  }
};
