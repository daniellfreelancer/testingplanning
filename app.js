...
const sesionesTallerEjecutadaPteAlto = require('./api/pteAlto/sesiones-taller-pte-alto/sesionesTallerEjecutadaPteAlto.routes')
...
app.use('/td-pte-alto', sesionesTallerEjecutadaPteAlto)
