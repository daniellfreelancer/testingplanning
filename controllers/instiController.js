...
const instiController = {
    ...
    readInstitutions : async (req, res) =>{
        ...
        try {
            ...
            let allInstitutions = await Institution.find().populate('teachers',{name: 1,lastName: 1, email:1, role: 1, rut: 1, logged: 1  }).populate('admins', {name: 1,lastName: 1, email:1, role: 1, rut: 1, logged: 1  })
