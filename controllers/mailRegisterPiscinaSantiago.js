...
const sendWelcomeMailPiscinaSantiago = async (email, password, name) => {
    try {
        ...
        <head>
          ...
          <style>
            ...
            /* Logo container */
            .logo-container { display: flex; justify-content: space-between; align-items: center; gap: 20px; flex-wrap: wrap; }
            .logo-link { display: inline-block; }
            .logo-img-small { width: 80px; height: 80px; object-fit: contain; }
            ...
            @media only screen and (max-width: 620px) {
              ...
              .logo-container { gap: 15px; justify-content: center; align-items: center; }
              .logo-img-small { width: 65px !important; height: 65px !important; }
            }
          </style>
          <!--[if mso]>
          <style type="text/css">
              ...
              <tr>
                <td class="header">
                  <div class="logo-container">
                    <a href="https://vitalmoveglobal.com" target="_blank" class="logo-link">
                      <img class="logo-img-small" src="https://gestion.vitalmove.cl/static/media/logoVMDark.bfb629aa47764b494994.png" alt="VitalMove Logo">
                    </a>
              ...
              <tr>
                <td class="body-content">
                  ...
                  <div class="button-wrapper">
                    ...
                    <![endif]-->
                    <!--[if !mso]><!-->
                    <a href="https://piscinasantiago.vitalmoveglobal.com/login" class="button" target="_blank">
                      INICIAR SESIÓN
                    </a>
                    <!--<![endif]-->
                  </div>
...
module.exports = sendWelcomeMailPiscinaSantiago;
